# AGENTS.md — Hinweise für KI-Agenten (gregMod.MoreSpools)

Repo: [https://github.com/mleem97/gregMod.MoreSpools](https://github.com/mleem97/gregMod.MoreSpools) · Lizenz: Apache-2.0 · Version: siehe `VERSION`.
